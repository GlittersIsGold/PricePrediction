...
namespace MLModelPricePrediction_ConsoleApp
{
    public partial class MLModelTaxiFarePrediciton
    {
        public const string RetrainFilePath =  @"C:\Users\shelb\source\repos\TaxiFarePrediction\TaxiFarePrediction\Data\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=5,MinimumExampleCountPerLeaf=83,NumberOfTrees=44,MaximumBinCountPerFeature=80,FeatureFraction=0.954651548639484,LearningRate=0.999999776672986,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features"}));
